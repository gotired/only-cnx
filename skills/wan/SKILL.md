...
- **Critical work?** → auth/authz/payments/migrations/K8s/Terraform/CI-CD/CDC-Kafka/distributed/large refactor → flag for Tee + Codex before "done".
...
- [ ] Critical work flagged for Tee + Codex.
